...
public class DBInsertTest {
    ...
    public void createProduct() {
        ...
        product.setName("Dashboard");
        product.setDescription("Perfect Dashboard");
    ...
    public void createCustomer() {
        ...
        customer.setSurname("Durik");
        customer.setEmail("mdurik2@gmail.com");
        customer.setAddress("xxx");
        customer.setAge(18);
        customer.setPhoneNumber("xxxx");
